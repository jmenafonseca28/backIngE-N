namespace BackIngE_N.Config.Messages.Channel {
    public static class ChannelError {
        ...
        public const string CHANNEL_NOT_UPDATED = "El canal no se pudo actualizar";
        public const string CHANNEL_NOT_DELETED = "El canal no se pudo eliminar";
        public const string CHANNEL_NOT_GET = "El canal no se pudo obtener";
        public const string DATA_EMPTY = "Los datos no pueden estar vacíos";
    }
}
